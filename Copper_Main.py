...
with tab1:    
        ...
        with st.form("my_form"):
            ...
            with col3:               
                ...
                quantity_tons = st.slider("Quantity Tons", min_value=611728, max_value=1722207579, step=1)
                thickness = st.slider("Thickness", min_value=0.18, max_value=400, step=0.01)
                width = st.slider("Width", min_value=1, max_value=2990, step=1)
                customer = st.slider("Customer ID", min_value=12458, max_value=30408185, step=1)
        ...
        if submit_button and flag==1:
            st.write("You have entered an invalid value. Please enter valid numbers.")
...
with tab2: 
        ...
        with st.form("my_form1"):
            ...
            with col1:
                cquantity_tons = st.slider("Quantity Tons", min_value=611728, max_value=1722207579, step=1)
                cthickness = st.slider("Thickness", min_value=0.18, max_value=400, step=0.01)
                cwidth = st.slider("Width", min_value=1, max_value=2990, step=1)
                ccustomer = st.slider("Customer ID", min_value=12458, max_value=30408185, step=1)
                cselling = st.slider("Selling Price", min_value=1, max_value=100001015, step=1) 
